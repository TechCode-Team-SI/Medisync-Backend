...
export class Migration1730458528504 implements MigrationInterface {
  name = 'Migration1730458528504';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`user_patient\` ADD \`address\` varchar(255) NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`user_patient\` DROP COLUMN \`address\``,
    );
    await queryRunner.query(
