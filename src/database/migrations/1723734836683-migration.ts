...
export class Migration1723734836683 implements MigrationInterface {
  name = 'Migration1723734836683';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`field_question\` ADD UNIQUE INDEX \`IDX_ceae8e79f35f151a597b57e085\` (\`field_question_id\`)`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`field_question\` DROP INDEX \`IDX_ceae8e79f35f151a597b57e085\``,
    );
    await queryRunner.query(
