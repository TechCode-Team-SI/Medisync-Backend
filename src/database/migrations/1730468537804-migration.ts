...
export class Migration1730468537804 implements MigrationInterface {
  name = 'Migration1730468537804';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`request\` ADD \`appointmentDate\` datetime NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`request\` DROP COLUMN \`appointmentDate\``,
    );
    await queryRunner.query(
