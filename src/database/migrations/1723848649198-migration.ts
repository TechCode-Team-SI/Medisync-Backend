...
export class Migration1723848649198 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`medical_center\` (\`id\` varchar(36) NOT NULL, \`name\` varchar(255) NOT NULL, \`address\` varchar(255) NOT NULL, \`state\` varchar(255) NOT NULL, \`municipality\` varchar(255) NOT NULL, \`parish\` varchar(255) NOT NULL, \`local_phone\` varchar(255) NOT NULL, \`mobile_phone\` varchar(255) NOT NULL, \`mission\` varchar(255) NOT NULL, \`vision\` varchar(255) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
